...
def _prepare_prefill_session(
    ...
    if modality == "text":
        ...
        mm_session = prepare_mm_session(runtime_config)
        model = mm_session.model
        raw_inputs = mm_session.raw_inputs
        runtime_inputs = mm_session.runtime_inputs
        extra = mm_session.extra
    else:
