...
_NAME_TO_MODULE = {
    "StageState": "qwen3vl_tp_runtime.hexgen_core.schema",
    ...
    "load_stage_state_by_index": "qwen3vl_tp_runtime.hexgen_core.modules.pipeline_parallel",
    "load_stage_state_for_rank": "qwen3vl_tp_runtime.hexgen_core.modules.pipeline_parallel",
    ...
    "build_stage_traces": "qwen3vl_tp_runtime.debug.tp_debug",
    "load_text_stage_bundle": "qwen3vl_tp_runtime.debug.tensor_parallel_replay",
    "run_text_tensor_parallel_stage": "qwen3vl_tp_runtime.debug.tensor_parallel_replay",
    "TextTensorParallelRunner": "qwen3vl_tp_runtime.debug.tensor_parallel_replay",
    "run_text_tensor_parallel_rank": "qwen3vl_tp_runtime.debug.tensor_parallel_replay",
    "TensorParallelManifest": "qwen3vl_tp_runtime.hexgen_core.modules.tensor_parallel",
    "TensorParallelRunner": "qwen3vl_tp_runtime.hexgen_core.modules.tensor_parallel",
    "load_tp_manifest": "qwen3vl_tp_runtime.hexgen_core.modules.tensor_parallel",
    "load_stage_state_for_tp_rank": "qwen3vl_tp_runtime.hexgen_core.modules.tensor_parallel",
    "run_tensor_parallel_rank": "qwen3vl_tp_runtime.hexgen_core.modules.tensor_parallel",
    "run_stage_state_tp": "qwen3vl_tp_runtime.hexgen_core.modules.tensor_parallel",
    ...
    "load_stage_state_for_hybrid_rank": "qwen3vl_tp_runtime.hexgen_core.modules.hybrid_parallel",
